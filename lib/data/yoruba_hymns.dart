...
List<HymnData> yorubaHymnData = [
  HymnData(1, 'Efi iyin fun Olorun', [
    '''
1. Efi iyin fun Olorun,
E yin, enyin eda aiye,
E yin, eyin eda orun.
Yin Baba, Omo on Emi.
'''
  ]),
  HymnData(2, 'Je k’ agb’ oju ayo s’ oke', [
    '''
1. Je k’ agb’ oju ayo s’ oke
Si agbala orun,
...
T’ ayo orun sile,
K’ orin iyin wa ga s’ oke
De ‘te t’ o l’ agbara.
''',
    '''
4. A m’ opo ope wa fun O,
Alagbawi t’ oke;
Ogo fun Oba t’ o wa lai,
T’o pa ‘binu Re mo.
'''
  ]),
  HymnData(3, 'Eyo gbogb’ orile-ede', [
    '''
...
'''
  ...
  HymnData(5, 'Niwaju ‘te Jehofa nla', [
    '''
...
'''
  ...
  HymnData(6, 'E yin Oluwa, e tun ohun se', [
    '''
...
Ki nwon si f’ orin fi ife Re han,
...
'''
  ...
  HymnData(7, 'Didun n’ ise na, Oba mi', [
    '''
...
'''
  ...
  HymnData(8, 'Ewole f’ Oba, ologo julo', [
    '''
...
'''
  ...
  HymnData(9, 'Yin Oluwa, oro didun', [
    '''
...
'''
  ...
  HymnData(10, 'Oluwa po! Ogun orun wole fun', [
    '''
...
'''
  ...
  HymnData(12, 'Iranse, e fonrere Oba nyin', [
    '''
...
'''
  ...
  HymnData(14, 'Gbogbo eda labe orun', [
    '''
...
'''
  ...
  HymnData(17, 'Baba wa ti o mbe l’ orun', [
    '''
...
3. Loni gbo ohun Re,
Mase fa ‘binu Re,
Wa, bi awon ayanfe Re,
Jewo Olorun re.
'''
  ]),
  HymnData(19, 'Oluwa t’ o mo julo', [
    '''
1. Oluwa t’ o mo julo,
K’ a wole l’ oruko Re;
Ife Re ki ye titi,
...
'''
  ...
  HymnData(20, 'Ko mi Oluwa bi a ti', [
    '''
...
Ki gbogbo wa yo si O.
'''
  ]),
  HymnData(22, 'Jesu, nib’ eni Re pade', [
    '''
...
'''
  ...
  HymnData(23, 'Mo j’ alejo nihin, ‘nu ile ajeji', [
    '''
...
'''
  ...
  HymnData(24, 'Gbat’ okan are fe ‘simi', [
    '''
...
''',
    '''
3. Sugbon wakati re nsare;
Ki o to de opin,
Emi Mimo masai fun mi
N’ isimi l’ okan mi.
'''
  ]),
  HymnData(25, 'Ojo mefa t’ ise koja', [
    '''
...
Lati wa, lati joba lai.
'''
  ]),
  HymnData(27, 'Kabo ojo ‘simi', [
    '''
1. Kabo ojo ‘simi
T’ o r’ ajinde Jesu;
...
'''
  ...
  HymnData(28, 'Ojo ‘simi at’ ayo', [
    '''
1. Ojo ‘simi at’ ayo
Ojo inu didun,
Etutu fun wahala,
T’ o dara, t’ o si ndan!
L’ ori re, awon ‘lola
At’ otosi nkorin,
Pe, “Mimo, mimo, mimo,”
S’ Eni Metalokan.
''',
    '''
2. L’ ori re ni did’ aiye
N’ imole ko ran si,
L’ ori re fun ‘gbala wa,
Jesu nde labe ‘le;
Ati nigbat’ O segun
O ran Emi wa ‘le,
Be l’ a ri pe l’ ori re,
N’ imole mata se.
''',
    '''
3. Loni fun gbogb’ alare,
Manna nwo lat’ orun;
Fere fadaka si npe,
Fun ipejo mimo;
Nibiti ihinrere
...
'''
  ...
  HymnData(29, 'Bo ti dun to l’ oj’ owo yi', [
    '''
...
'''
  ...
  HymnData(31, 'Baba, aniyan at’ eru', [
    '''
...
'''
  ...
  HymnData(32, 'Oluwa, isimi Re dun', [
    '''
...
'''
  ...
  HymnData(33, 'Gbogb’ ogun orun nro keke', [
    '''
...
'''
  ...
  HymnData(39, 'Eyi l’ ojo Oluwa da', [
    '''
...
'''
  ...
  HymnData(41, 'Fi ibukun Re tu wa ka', [
    '''
...
'''
  ...
  HymnData(43, 'Li o wuro Iwo o gbo', [
    '''
...
'''
  ...
  HymnData(44, 'Ni kutu, mo de Oluwa', [
    '''
...
''',
    '''
4. Be, titi emi mi o pin,
Ngo bukun Oba mi,
Ngo gbe owo ebe soke,
Ngo f’ ete mi korin.
'''
  ]),
  HymnData(45, 'Jesu bukun oro Re', [
    '''
1. Jesu bukun oro Re,
...
'''
  ...
  HymnData(46, 'Akoko ‘re gbat’ eda te', [
    '''
...
'''
  ...
  HymnData(47, 'Ji okan mi, ba orun ji', [
    '''
...
'''
  ...
  HymnData(48, 'Olorun kutu ohun Re', [
    '''
...
'''
  ...
  HymnData(49, 'Gbat’ oju mi ba se peki', [
    '''
1. Gbat’ oju mi ba se peki
‘Mole to se n’ ila orun,
Orun ododo masai ran
Ase anu re s’ ori mi,
K’o le iji ebi kuro
K’o so okun mi d’ imole.
''',
    '''
2. Gba m’ ba mu ebo owuro
Wa siwaju Oba orun,
Ti mo nsofo itiju mi,
Ti mo mbe l’ oruko Jesu;
Olugbala fi eje Re
We mi, si s’ Alagbawimi.
''',
    '''
3. ‘Gbati ise ojo pari,
Ti ara are fe ‘simi,
F’ idariji anu bukun,
Si so mi nigba m’ba simi;
B’ orun ojo keji tin ran
Ma sin mi lo lona orun.
''',
    '''
4. Gbat’ orun aiye mi ba wo,
T’ ija at’ ise mi d’ opin,
Jesu tan ase orun Re
S’ ori akete iku mi,
K’ O ji mi lat’ okun iku,
Lati ri o kin le yin O.
'''
  ]),
  HymnData(50, 'Okan mi, oju re tun ri', [
    '''
...
Osan tun pe l’ otun,
Ogb’ ile b’ ibujoko Re,
T’ O gbe nyi akoko.
''',
    '''
3. On l’ O da ara mi duro,
Ahon mi o yin I,
Ese mi fe ru inu Re,
Sugbon ‘binu lora.
''',
...
'''
  ...
  HymnData(51, 'Nigbat’ imole owuro', [
    '''
...
'''
  ...
  HymnData(53, 'Otun ife l’ o nfarahan', [
    '''
...
'''
  ...
  HymnData(55, 'Ninu gbogbo ewu oru', [
    '''
...
'''
  ...
  HymnData(56, 'Oluwa mi, mo njade lo', [
    '''
...
'''
  ...
  HymnData(57, 'Mimo, mimo, mimo! Olodumare!', [
    '''
...
''',
    '''
2. Mimo, mimo, mimo! Awon ti orun nyin
...
'''
  ...
  HymnData(58, 'Mo fe iyera s’ apakan', [
    '''
...
'''
  ...
  HymnData(60, 'Lat’ ori pepe okan wa', [
    '''
...
'''
  ...
  HymnData(61, 'K’ a to sun, Olugbala wa', [
    '''
...
'''
  ...
  HymnData(63, 'Wo Imole! larin okun aiye', [
    '''
1. Wo Imole! larin okun aiye,
Ma sin mi lo.
Okunkun su, mo si jina s’ ile,
Ma sin mi lo.
To ‘sise mi: bi ona ti jin to,
Nki o bere; ‘sise kan to fun mi.
''',
    '''
...
''',
    '''
3. Ipa Re l’o ti ndi mi mu, yio si
Ma sin mi lo;
...
''',
    '''
4. Ko to d’ igba na, lona aiye yi
T’ Iwo ti rin,
...
'''
  ...
  HymnData(65, 'Baba, a tun pade l’ oko Jesu', [
    '''
1. Baba, a tun pade l’ oko Jesu,
A si wa teriba lab’ ese Re;
Si O l’ a tun fe gb’ ohun wa s’ oke
Lati wa anu, lati ko ‘rin ‘yin.
''',
    '''
2. A yin O fun itoju ‘gbagbogbo,
‘Jojumo l’ a o ma so t’ ise Re:
Wiwa l’aiye wa, anu Re ha ko?
Apa Re ki O si fi ngba ni mora?
''',
    '''
...
S’ ilekun anu, si gbani s’ ile.
'''
  ]),
  HymnData(66, 'Iwo imole okan mi', [
    '''
1. Iwo imole okan mi,
Li odo Re oru ko si,
...
''',
    '''
4. B’ awon otosi omo Re
Ta ‘pa si oro Re l’ oni,
Oluwa sise ore Re,
Ma je k’ a joko si ese.
''',
    '''
...
'''
  ...
  HymnData(67, 'Oluwa, ojo t’ O fun wa pin', [
    '''
...
'''
  ...
  HymnData(68, 'L’ oju ale, ‘gbat’ orun wo', [
    '''
...
'''
  ...
  HymnData(69, 'Ife Re da wa si loni', [
    '''
...
'''
  ...
  HymnData(71, 'Ogo f’ Olorun l’ ale yi', [
    '''
...
'''
  ...
  HymnData(72, 'Jesu, bukun wa k’ a to lo', [
    '''
...
'''
  ...
  HymnData(73, 'Olugbala, a tun fe f’ ohun kan', [
    '''
...
'''
  ...
  HymnData(74, 'Iwo ti gbogbo eda nsin', [
    '''
1. Iwo ti gbogbo eda nsin
L’ ara erupe yi,
Bi O ti tobi to l’aiye!
B’ ogo Re ti po to!
''',
    '''
2. Nigbati mo f’ iyanu wo
Ogo ‘se Re l’ oke,
...
''',
    '''
4. Iwo ti gbogbo eda nsin
L’ ara erupe yi,
Bi O tit obi to l’ aiye!
B’ ogo Re ti po to.
'''
  ]),
  HymnData(75, 'Olorun wa aiyeraiye', [
    '''
...
4. O f’ ife j’ aiye re
Gbat a ra o n’boji;
Ent’t’ o gb’ okan mi n'nu ‘parun
N’ ipa lati gbala.
'''
  ]),
  HymnData(78, 'Mo korin ipa Olorun', [
    '''
...
'''
  ...
  HymnData(79, 'Eje k’ a f’ inu didun', [
    '''
...
'''
  ...
  HymnData(80, 'Olorun l’ abo eni Re', [
    '''
...
'''
  ...
  HymnData(82, 'Ife l’ Olorun: anu Re', [
    '''
...
'''
  ...
  HymnData(83, 'T’ olorun n’ ijoba gbogbo', [
    '''
...
'''
  ...
  HymnData(84, 'Ona ara l’ Olorun wa', [
    '''
...
'''
  ...
  HymnData(86, 'Saju wa nso, Olorun', [
    '''
1. Saju wa nso, Olorun,
Fere ogun ti ro;
Ninu papa isegun,
...
'''
  ...
  HymnData(87, 'Ayo b’ aiye: Oluwa de', [
    '''
...
'''
  ...
  HymnData(88, 'Ma wo ‘le, Jesu t’ a nreti', [
    '''
...
'''
  ...
  HymnData(89, 'Wo oju sanma ohun ni', [
    '''
...
'''
  ...
  HymnData(90, 'Gbo ‘gbe ayo! Oluwa de', [
    '''
...
'''
  ...
  HymnData(91, 'Ilu t’ o dara po l’ aiye', [
    '''
...
'''
  ...
  HymnData(92, 'Ode, Kristi Oluwa', [
    '''
1. Ode, Kristi Oluwa,
Lat’ ibugbe Re l’ orun,
Lat’ ite alafia.
O wa si aginju wa.
''',
    '''
...
'''
  ...
  HymnData(93, 'Ojo ayo nlanla na de', [
    '''
...
'''
  ...
  HymnData(94, 'Wo! gbogbo ile okunkun', [
    '''
...
'''
  ...
  HymnData(95, 'Gbo eda orun nkorin', [
    '''
...
'''
  ...
  HymnData(96, 'Ayo kun okan wa loni', [
    '''
...
'''
  ...
  HymnData(97, 'Onigbagbo, e bu s’ ayo', [
    '''
...
'''
  ...
  HymnData(100, 'Enyin Angel’ l’ orun ogo', [
    '''
...
'''
  ...
  HymnData(101, 'Ji, ‘wo Kristian, k’ o ki oro ayo', [
    '''
...
'''
  ...
  HymnData(102, 'A jin jin, oru mimo', [
    '''
...
'''
  ...
  HymnData(103, 'Sunm’ odo wa, Emmanuel', [
    '''
...
'''
  ...
  HymnData(104, 'A nt’ ona t’ Oluwa wa rin', [
    '''
1. A nt’ ona t’ Oluwa wa rin:
A ngb’ agbelebu Re;
...
'''
  ...
  HymnData(105, 'N’nu ‘se, n’nu ‘ja, Oluwa mi', [
    '''
...
'''
  ...
  HymnData(106, 'Jesu, O ha re ‘ra Re le', [
    '''
...
'''
  ...
  HymnData(107, 'Oganjo gan: l’ oke Olif', [
    '''
1. Oganjo gan: l’ oke Olif’
Awon irawo si ti wo;
Oganjo gan: nisisyi
...
'''
  ...
  HymnData(108, 'OparI! – l’ Olugbala ke', [
    '''
...
'''
  ...
  HymnData(110, 'Mo f’ ara Mi fun o', [
    '''
1. Mo f’ ara Mi fun o,
Mo ku nitori re,
Ki nle ra o pada,
...
'''
  ...
  HymnData(111, 'A ra, e wa ba mi s’ ofo', [
    '''
...
'''
  ...
  HymnData(112, 'Egb’ ohun ife at’ anu', [
    '''
...
'''
  ...
  HymnData(113, 'Olugbala mi ha gb’ ogbe', [
    '''
...
'''
  ...
  HymnData(114, 'Agbelebu ni ere mi', [
    '''
...
'''
  ...
  HymnData(115, 'Gbo-gb’ ogo iyin ola', [
    '''
...
'''
  ...
  HymnData(116, 'Wo t’ o nbebe f’ ota Re', [
    '''
...
'''
  ...
  HymnData(117, 'Ma gesin lo l’ olanla Re', [
    '''
...
'''
  ...
  HymnData(118, 'Krist’ Oluwa ji loni, – Halleluyah', [
    '''
1. Krist’ Oluwa ji loni, – Halleluyah,
...
'''
  ...
  HymnData(120, 'Orun, korin! Aiye, yo', [
    '''
...
'''
  ...
  HymnData(122, 'Kabo ojo rere, ” l’ ao ma wi titi', [
    '''
...
Awon t’ o si subu, jo gbe won dide,
F’ ojurere Re han, je k’ aiye riran,
Tun mu ‘mole wa de, ‘ Wo sa ni ‘mole.
“Kabo ojo rere,” etc
'''
  ]),
  HymnData(123, 'Alleluya! Alleluya!! Alleluya!!!', [
    '''
...
'''
  ...
  HymnData(124, 'Halleluyah, Halleluyah', [
    '''
...
'''
  ...
  HymnData(125, 'Jesu ye; titi aiye', [
    '''
1. Jesu ye; titi aiye
Eru iku ko ba ni mo;
Jesu ye; nitorina
...
'''
  ...
  HymnData(126, 'Oluwa mbo aiye o mi', [
    '''
...
'''
  ...
  HymnData(127, 'Olorun! Kini mo ri yi', [
    '''
...
''',
    '''
2. Oku ‘nu Kristi y’o ko jinde,
Nigba ‘pe kehin ba dun,
Nwon o lo ko l’awosanna,
Nwon o fi ayo yi ka;
...
'''
  ...
  HymnData(128, 'Jesu t’o k’o gb’aiye la', [
    '''
...
Ki n won ba joba lai.
'''
  ]),
  HymnData(129, 'Belese s’owo po', [
    '''
1. Belese s’owo po,
Ti nwon nde s’Oluwa,
Dimo si Kristi Re,
...
'''
  ...
  HymnData(130, 'L’owuro, Ojo ajinde', [
    '''
...
'''
  ...
  HymnData(131, 'Oru bu koja tan', [
    '''
1. Oru bu koja tan
Osan ku si dede:
Iboju fere ya
T’o bo Olugbala;
Sanma ti odi wa loju
...
'''
  ...
  HymnData(132, 'Enyin t’e f’Oluwa', [
    '''
1. Enyin t’e f’Oluwa,
T’o mo ‘pa Re, e wa,
E dapo n' isokan,
...
'''
  ...
  HymnData(133, 'Afun iho ayo mimo', [
    '''
1. Afun iho ayo mimo
S’ Olorun Oba nla!
...
''',
    '''
2. Jesu Oluwa wa goke
Eso orun yi ka,
Nwon ba goke bi O ti nlo,
Pelu iro fere.
''',
    '''
3. B’ Angeli ti nyin Oba won,
K’ eda ko orin na;
...
'''
  ...
  HymnData(135, 'Ife orun alailegbe', [
    '''
...
'''
  ...
  HymnData(136, 'Gbogbo aiye, gbe jesu ga', [
    '''
...
''',
  ...
  HymnData(138, 'Gb’ opo duru pelu ohun', [
    '''
...
'''
  ...
  HymnData(140, 'Mo mo p’ Oludande mi mbe', [
    '''
...
'''
  ...
  HymnData(141, 'Emi ‘bukun, bi afefe', [
    '''
...
'''
  ...
  HymnData(142, 'So itan kanna fun mi', [
    '''
...
'''
  ...
  HymnData(143, 'Oluwa, y’o ti pe to', [
    '''
...
'''
  ...
  HymnData(144, 'Ji, apa Olorun, k’ o ji', [
    '''
...
'''
  ...
  HymnData(145, 'Wo! Oluwa l’ awonsanma', [
    '''
...
'''
  ...
  HymnData(147, 'Gba t’ Olugbala w’ aiye', [
    '''
...
'''
  ...
  HymnData(148, 'A won eye n’ ite', [
    '''
1. A won eye n’ ite,
Kolokolo n’ iho, enia n’ ile:
Eda n’ ib’ isimi
Sugbon Jesu ko r’ ibi gborile.
''',
    '''
2. Sibe O mu sinmi
Wa f’ awon elese on alare;
O f’ iye f’ elese,
O mu gbogbo ‘banuje wa kuro.
''',
    '''
3. Mo ba ninu je ri,
Mo si ti bi Emi Re ninu ri,
Eni t’ a kan mo ‘gi
T’ a si fi ade egun de lori.
''',
    '''
4. Ife Re ti ki sa
On na lofi alafia fun mi:
Eyi ti kio dekun,
Titi ngo d’ ajogun ijoba Re.
''',
    '''
5. Bikos’ ore ofe,
Mo mo pee m,’ ki ba ti le ri
Oju Re didan ni
To ti sa fun rora nitori mi.
''',
    '''
6. K’ eye wa ite won,
Kolokolo at’ enia ‘bubge won,
Oluwa w’ okan mi
Si f’ ori re le okan aya mi.
''',
    '''
7. ‘Wo fe lati ma gbe
Okan ‘rele to kanu fun ese,
Wa ki O si simi
Nnu okan rora on ‘banuje yi.
'''
  ]),
  HymnData(149, 'Krist’ ki ‘joba Re de', [
    '''
...
'''
  ...
  HymnData(152, 'Olurapada wa, k’ On to', [
    '''
...
'''
  ...
  HymnData(153, 'Wa, Emi ‘re, ‘Daba orun', [
    '''
1. Wa, Emi ‘re, ‘Daba orun
Pelu itunu lat’ oke;
S’ alabo at’ Oluto wa,
To ero at’ isise wa.
''',
...
'''
  ...
  HymnData(154, 'Emi Mimo, ‘Daba orun', [
    '''
...
'''
  ...
  HymnData(155, 'Emi orun, gb’ adura wa', [
    '''
...
'''
  ...
  HymnData(157, 'Ogo fun Olorun Baba', [
    '''
...
''',
    '''
2. Ogo fun Enit’ o fe wa,
T’ o we abawon wa nu;
Ogo fun Enit’ o ra wa,
...
'''
  ...
  HymnData(158, 'A f’ iyin aiku fun', [
    '''
1. A f’ iyin aiku fun
‘Fe Olorun Baba,
Fun itunu t’ aiye,
...
'''
  ...
  HymnData(159, 'F’ oruk’ Olorun loke', [
    '''
...
'''
  ...
  HymnData(160, 'OLORUN ti fi Jesu se', [
    '''
...
'''
  ...
  HymnData(161, 'Oluwa, alaimo l’ emi', [
    '''
...
'''
  ...
  HymnData(163, 'Oluwa, bawo l’ okan mi', [
    '''
...
'''
  ...
  HymnData(164, 'Asan n’ ireti t’ enia ko', [
    '''
...
T’ a ba gbekele O,
‘Gbagbo wa ri ododo gba,
T’ o je k’ elese pe.
'''
  ]),
  HymnData(165, 'Gbat’ emi re ba fo lo', [
    '''
...
'''
  ...
  HymnData(168, 'Elese kil’ o ni t’ o', [
    '''
...
'''
  ...
  HymnData(169, 'A ye si mbe!” ile Odagutan', [
    '''
...
''',
    '''
2. Loto, ese re lo se,
L’o kan ‘so t’o mu mo ‘gi,
L’o fi egun de l’ ade, 
L’o fi oko s’ egbe Re;
O s’ okan Re d’ etutu,
Ni kiku fun elese.
''',
    '''
...
'''
  ...
  HymnData(171, 'Elese, o ha gan ise', [
    '''
...
'''
  ...
  HymnData(172, 'Ese ti e ko le sailo', [
    '''
...
'''
  ...
  HymnData(173, 'Mura elese lati gbon', [
    '''
...
'''
  ...
  HymnData(174, 'Oluwa mo gb’ ohun Re', [
    '''
...
'''
  ...
  HymnData(176, 'Enit’ o ba gbo, kigbe iro na', [
    '''
...
'''
  ...
  HymnData(177, 'Iye wa ni wiwo, Enit a kan mo ‘gi', [
    '''
...
''',
    '''
2. Kil’ o se ti On fi dabi Ogberari
...
'''
  ...
  HymnData(178, 'Oluwa, sanu, dariji', [
    '''
1. Oluwa, sanu, dariji;
...
'''
  ...
  HymnData(179, 'Ebi ese npa mi l’ eru', [
    '''
...
T’ okan mi yio d’ otun.
'''
  ]),
  HymnData(180, 'Oluwa, Ob’ Alase', [
    '''
1. Oluwa, Ob’ Alase,
A wole ni ese Re;
Gbo igbe itara wa,
...
Ki ngbagbo, ki nma se mo.
'''
  ]),
  HymnData(183, 'Olugbala, li ese Re', [
    '''
1. Olugbala, li ese Re
L’olote kan wole ,
...
Dari ese ji mi:
Ododo Re ki y’o ko pe
Ki elese k’ o la.
'''
  ]),
  HymnData(184, 'Mo ti mb’ ese rin ti pe', [
    '''
...
'''
  ...
  HymnData(186, 'Ese mi po bi irawo', [
    '''
...
'''
  ...
  HymnData(187, 'Iwo low’ Enit’ ire nsan', [
    '''
...
'''
  ...
  HymnData(188, 'Olugbala, gb’ ohun mi', [
    '''
...
'''
  ...
  HymnData(189, 'Oluwa, ma m’ oju kuro', [
    '''
...
'''
  ...
  HymnData(190, 'Oluwa, b’ agbowode ni', [
    '''
...
'''
  ...
  HymnData(191, 'Baba ma yi oju kuro', [
    '''
...
'''
  ...
  HymnData(192, 'Jesu nfe gba elese', [
    '''
...
'''
  ...
  HymnData(193, 'Ekun ko le gba mi', [
    '''
1. Ekun ko le gba mi,
...
'''
  ...
  HymnData(194, 'Gbo elese, Anu npe o', [
    '''
1. Gbo elese, Anu npe o,
Ohun didun l’ Ofi npe
O nke yara w’ Olugbala,
K’ owo are to subu;
Sun le Jesu,
Ohun anu l’o npe o.
''',
    '''
2. Sa elese t’ Olugbla,
Wa anu Re k’ o to bo,
Ojo anu fere koja,
Emi re fere pin na;
Sa to Jesu,
...
'''
  ...
  HymnData(195, 'Je ki gbogbo eti ko gbo', [
    '''
1. Je ki gbogbo eti ko gbo,
Ki gbogbo okan yo,
Ipe ‘hinrere nfi ohun
Ifanimora dun.
''',
    '''
2. Enyin okan ti ebi npa,
T’o nf’ategun s’ onje,
T’o nja lasan, lati fi nkan
Aiye b’ okan ebi.
''',
    '''
...
'''
  ...
  HymnData(197, 'Bi o ti ri laisi ami', [
    '''
...
'''
  ...
  HymnData(198, 'Mo fi omije wo yika', [
    '''
...
'''
  ...
  HymnData(199, 'W' alejo kan lenu ona', [
    '''
1. W' alejo kan lenu ona:
...
'''
  ...
  HymnData(200, 'KO s’ ohun t’ o ku kin se', [
    '''
...
'''
  ...
  HymnData(201, 'EYI, e yipada, ese t’ e o ku', [
    '''
...
''',
    '''
2. Asan ni itanje pe t’ e ba duro
...
'''
  ...
  HymnData(202, 'ALAFIA w’ okan, t’ ohun re', [
    '''
...
'''
  ...
  HymnData(203, 'Are mu o, aiye su o', [
    '''
...
O ni k’ e wa loni,
Bi e tile tosi;
Gbogbo nkan setan, ‘lese wa:
Fun gbogbo okan aye mbe.
''',
    '''
...
4. Enyin t’ ife Re fa,
E sunmo odo Re;
Kristi t’ oke pe nyin,
E gb’ ohun didun Re;
Enikeni t’ o fe k’ o wa
Ni aiya anu, aye mbe.
'''
  ]),
  HymnData(205, 'JESU npe wa l’ osan, l’ oru', [
    '''
...
'''
  ...
  HymnData(206, 'WA sodo Jesu, mase duro', [
    '''
...
“Wa, omo Mi, e wa!”.
 '''
  ...
  HymnData(207, 'GBO okan mi, bi Angeli ti nkorin', [
    '''
...
'''
  ...
  HymnData(209, 'NIGBAT’ idanwo yi mi ka', [
    '''
...
'''
  ...
  HymnData(211, 'ELESE wa sodo Jesu', [
    '''
...
'''
  ...
  HymnData(212, 'OKAN mi, sunmo ‘te anu', [
    '''
...
'''
  ...
  HymnData(213, 'LO, l’ oro kutukutu', [
    '''
1. LO, l’ oro kutukutu,
Lo, ni osangangan,
Lo, ni igba asale,
...
'''
  ...
  HymnData(214, 'PADA asako s’ ile re', [
    '''
...
'''
  ...
  HymnData(215, 'OMO Olorun nlo s’ ogun', [
    '''
...
'''
  ...
  HymnData(216, 'OLORUN npe, ngo ha s’ aigbo', [
    '''
...
'''
  ...
  HymnData(217, 'O HA le je p’ a pe mi?', [
    '''
1. O HA le je p’ a pe mi?
Olugbala ha yan mi?
Bi ebi mi ti po to
O ha da oruko mi?
Olor’ elese ni mi
...
'''
  ...
  HymnData(218, 'MO ha le tun duro', [
    '''
1. MO ha le tun duro
Laif’ ini mi toro?
...
'''
  ...
  HymnData(219, 'WO ti ngb’ adura igbagbo', [
    '''
1. WO ti ngb’ adura igbagbo,
O ki o gb’ okan lowo ‘ku
T’ o gb’ ara re le O?
...
'''
  ...
  HymnData(220, 'BABA, mo n’ owo mi si O', [
    '''
...
'''
  ...
  HymnData(221, 'JESU, Ore ‘lese ni O', [
    '''
...
'''
  ...
  HymnData(222, 'BI mo ti ri – laisawawi', [
    '''
...
''',
  ...
  HymnData(224, 'ELESE; – mo nfe ‘bukun', [
    '''
...
“Jesu ti Nasaret’ ti nkoja.”
'''
  ]),
  HymnData(226, 'JINNA kuro n’ ibugbe enia', [
    '''
1. JINNA kuro n’ ibugbe enia,
L’ a gbo ‘gbe awon adete mewa:
Jesu sanu fun won, se wosan won
Okan l’ o wa dupe, Mesan ha da?
  Mesan ha da? Mesan ha da?
  Mewa k’a wosan, Mesan ha da?
''',
    '''
2. Alejo na korin ‘yin s’ Oluwa,
O mo p’ Oro Re lo mu ‘wosan wa:
O gba Onisegun nla l’ Oluwa,
Jesu wi jeje pe, Mesan ha da?
  Mesan ha da? etc.
''',
    '''
3. Farisi bere, Tani Nasiri
So fun ni daju bi On ni Krist’ na,
Opo l’o ntele t’o nbere ami
Ise ‘yanu nla Re, Mesan ha da?
 Mesan ha da? etc.
''',
    '''
4. Jesu niwaju Onidajo Aiye
Opo l’o nf’ egan bere “Tani yi”?
Nwon nko Oluwa re ati t’ emi
Nwon m’ Olufisun wa, Mesan ha da?
  Mesan ha da? etc.
'''
  ]),
  HymnData(227, 'WA, Jesu fi ara han', [
    '''
...
'''
  ...
  HymnData(228, 'NIHINYI n’ isimi gbe wa', [
    '''
...
'''
  ...
  HymnData(229, 'B’ AWON ara igbani', [
    '''
1. B’ AWON ara igbani
Ti f’ ayo ri ‘rawo na;
...
'''
  ...
  HymnData(230, 'TIRE l’ emi se, mo ti gb’ ohun Re', [
    '''
1. TIRE l’ emi se, mo ti gb’ ohun Re,
O nso ife Re si mi:
...
'''
  ...
  HymnData(231, 'TIRE lailai l’ awa se', [
    '''
...
'''
  ...
  HymnData(232, 'ISUN kan wa t’ o kun f’ eje', [
    '''
...
''',
    '''
2. ‘Gba mo f’i gbagbo r’ isun na,
Ti nsan fun ogbe Re,
Irapada d’ orin fun mi
Ti ngo ma ko titi.
''',
    '''
3. Ninu orin t’ o dun julo,
L’ emi o korin Re:
...
'''
  ...
  HymnData(234, 'JESU ti mo gbeke mi le', [
    '''
...
'''
  ...
  HymnData(236, 'NIGBA itiju ko bo mi', [
    '''
1. NIGBA itiju ko bo mi,
...
'''
  ...
  HymnData(237, 'JESU oluf’ okan mi', [
    '''
1. JESU oluf’ okan mi,
...
'''
  ...
  HymnData(239, 'BI mo ni egbarun ebun', [
    '''
1. BI mo ni egbarun ebun,
...
'''
  ...
  HymnData(241, 'OLUWA ib’ isadi mi', [
    '''
1. OLUWA ib’ isadi mi,
‘Wo ni mo gbekele;
...
'''
  ...
  HymnData(242, 'MO k’ ese mi le Jesu', [
    '''
...
'''
  ...
  HymnData(243, 'WO Ore okan ti nkanu', [
    '''
...
'''
  ...
  HymnData(245, 'ENI ba gbekel’ Olorun', [
    '''
...
'''
  ...
  HymnData(246, 'KI nko ohun gbogbo sile', [
    '''
...
Lati odo Re wa;
Mo le p’ adanu ini mi
Fun ayo ere mi.
'''
  ]),
  HymnData(247, 'OLUWA l’ atilehin mi', [
    '''
...
'''
  ...
  HymnData(249, 'GBEKELE ojojumo', [
    '''
1. GBEKELE ojojumo,
‘Gbekele ninu iji,
B’ igbgbo tile kere,
Ki nsa gbekele Jesu.
  B’ iseju ti nfo Kankan,
  Bi ojo nkoja lo,
  Ohunkohun t’ o le de,
  Gbekele Jesu nikan.
''',
...
'''
  ...
  HymnData(250, 'GBEKELE onigbagbo', [
    '''
1. GBEKELE onigbagbo,
B’ ija na tile pe,
Sibe iwo yio segun,
...
'''
  ...
  HymnData(252, 'OLUWA, Baba orun', [
    '''
1. OLUWA, Baba orun,
B’ oju wo mo-‘do Re
Ti nro t’ igbe aiye re,
Ati ipo re si O.
''',
    '''
2. Mo n’ igbgbo si Jesu,
Si agbara iku Re,
S’ ajinde Re, apere
Iye lehin iku mi.
''',
    '''
3. Emi Re l’ o s’ ise yi,
L’ O mu mi mo ebi mi,
L’ O toka ‘gbala si mi,
L’ O mu mi gba Kristi gbo.
''',
    '''
4. Sugbon sibe okan mi,
Nd’ igba se kilakilo,
Nitor’ ese to mo nda,
Alailera sa l’ emi.
''',
...
5. Fun mi ni idaloju
Isimi okan toto,
T’ awon ‘mo-ehin Re gbo,
Ti aiya won si bale.
''',
    '''
6. Wi f’ okan mi, Oluwa,
(Iwo nikan l’ O le wi,)
Pe a ti k’ oruko re
Sinu ‘we iye l’ oke.
''',
    '''
7. ‘Gbana mo le n’ igboya
Lati wi bi paulu pe,
“Ko s’ ohun l’ aiye, l’ orun
T’ o le ya t’ emi Tire.”
'''
  ]),
  HymnData(253, 'NIPA ife Olugbala', [
    '''
1. NIPA ife Olugbala,
Ki y’o si nkan;
Oju rere Re ki pada.
...
'''
  ...
  HymnData(254, 'LAIFOYA l’ apa Jesu', [
    '''
1. LAIFOYA l’ apa Jesu,
Laifoya l’ aiya Re,
Labe ojij’ ife Re,
L’ okan mi o simi.
Gbo ohun angeli ni,
...
Lati papa ogo wa,
Lati okun jaspi.
Laifoya l’ apa Jesu, Laifoya l’ aiya Re,
Labe ojij’ ife Re, L’ okan mi o simi.
''',
    '''
2. Laifoya l’apa Jesu,
Mo bo low’ aniyan,
Mo bo lowo idanwo,
Ese ko n’ ipa mo.
Mo bo lowo ‘banuje,
...
'''
  ...
  HymnData(255, 'GBA mo le ka oye mi re', [
    '''
...
'''
  ...
  HymnData(256, 'IGBAGBO mi duro l’ori', [
    '''
...
'''
  ...
  HymnData(257, 'OLORUN mi bojuwo mi', [
    '''
...
'''
  ...
  HymnData(258, 'NIGBA nwon kehin si Sion', [
    '''
...
'''
  ...
  HymnData(259, 'ALAFIA, li aiye ese yi', [
    '''
...
'''
  ...
  HymnData(260, 'GB’ ori re soke alare', [
    '''
1. GB’ ori re soke alare,
Tori ayo nbo l’ owuro,
Olorun so n’nu oro Re
Pe ayo ma nbo l’ owuro,
  Ayo ma nbo l’ owuro,
  Ayo ma nbo l’ owuro,
  Ekun le pe titi d’ ale
  Sugbon ayo nbo l’ owuro.
''',
    '''
2. Enyin mimo ma beru mo
Tori ayo nbo l’ owuro;
Enyin olofo nu ‘ju nu,
Tori ayo nbo l’ owuro.
''',
    '''
3. E yo oru fere koja,
Tori ayo nbo l’ owuro;
O ‘ro t’ o logo yio si de
Tori ayo nbo l’ owuro.
''',
    '''
4. Ki gbogbo wa ma yo loni
Tori ayo nbo l’ owuro.
Olorun yio n’ omije nu
Tori ayo nbo l’ owuro.
  Ayo ma nbo l’ owuro,
  Ayo ma nbo l’ owuro,
  Ekun le pe titi d’ ale
...
'''
  ...
  HymnData(261, 'F’ORUKO Jesu s’ okan re', [
    '''
...
'''
  ...
  HymnData(262, 'KO si ewa nibikan ti', [
    '''
1. KO si ewa nibikan ti
Mo le fi we ti Krist’:
Ohun t’ o ku, Oluwa, ni
K’ a je ‘kan pelu Re.
''',
    '''
2. Mu imo iku, ife Re
...
'''
  ...
  HymnData(263, 'NGO fe O, Olorun Baba', [
    '''
...
'''
  ...
  HymnData(264, 'MO ti ni Jesu l’ore', [
    '''
...
Bi aiye tile ko mi
Ti Satan dan mi wo,
Jesu yio mu mi d’ opin irin mi:
On n’ itanna ipado,
Irawo Owuro
On nikan l’ Arewa ti okan mi fe,
   Olutunu mi l’ O je, etc
''',
    '''
...
'''
  ...
  HymnData(265, 'MO fe O, Olorun, sugbon', [
    '''
...
'''
  ...
  HymnData(266, 'IFE orun, o ti dun to', [
    '''
...
'''
  ...
  HymnData(267, 'NGO feran Re, Wo odi mi', [
    '''
...
'''
  ...
  HymnData(268, 'B’ORUKO Jesu ti dun to', [
    '''
...
'''
  ...
  HymnData(270, 'MO fe O n’gbagbogbo,', [
    '''
...
'''
  ...
  HymnData(273, 'GBA aiye mi, Oluwa', [
    '''
1. GBA aiye mi, Oluwa,
Mo ya si mimo fun O;
Gba gbogbo akoko mi,
...
Kin ma lo fun ife Re;
Gba ese mi, k’ O si je
Ki nwon ma sare fun O.
''',
    '''
3. Gba ohun mi, je kin ma
Korin f’ Oba mi titi;
...
Ki y’o tun je t’ emi mo
Gb’ okan mi, Tire ni se,
Ma gunwa nibe titi.
''',
    '''
...
'''
  ...
  HymnData(274, 'BI agbonrin ti nmi hele', [
    '''
...
'''
  ...
  HymnData(275, 'EMI ko mo ‘gbat’ Oluwa yio de', [
    '''
...
Sugbon mo mo pe ao d’ oruko Jesu,
Eyini yio j’ orin fun mi,
  Eyini yio j’ orin fun mi, etc
''',
    '''
3. Emi ko mo b’ ile m’ orun ti ri,
Ati oruko ti ngo je nibe,
Sugbon mo mo pe Jesu yio pe mi wo ‘le,
Eyini yio j’ orun fun mi,
  Eyini yio j’ ogo fun mi, etc
'''
  ]),
  HymnData(276, 'WA, iwo isun ibukun', [
    '''
...
'''
  ...
  HymnData(277, 'GBAT, a b’Oluwa rin', [
    '''
...
'''
  ...
  HymnData(278, 'AYO omo anu ti to', [
    '''
1. AYO omo anu ti to!
T’ o mo idariji:
...
'''
  ...
  HymnData(280, 'BENI, O bikita fun mi', [
    '''
...
'''
  ...
  HymnData(281, 'JESU o ye ki nl’ ayo', [
    '''
...
'''
  ...
  HymnData(284, 'OKAN mi nsimi, Oluwa', [
    '''
...
'''
  ...
  HymnData(285, 'ENYIN t’ e fe Oluwa', [
    '''
...
'''
  ...
  HymnData(286, 'MO gbohun Jesu t’ o wipe', [
    '''
1. MO gbohun Jesu t’ o wipe,
“Wa simi lodo Mi;
Gbe ori re, ‘wo alare,
Le okan aiya Mi.”
Ninu are on ‘banuje,
...
'''
  ...
  HymnData(287, 'ISIN l’ o le fun wa li', [
    '''
...
'''
  ...
  HymnData(288, 'JESU, kiki ironu Re', [
    '''
...
'''
  ...
  HymnData(289, 'OLORUN ‘yanu! Ona kan', [
    '''
...
'''
  ...
  HymnData(290, 'JI, okan mi dide l’ ayo', [
    '''
...
'''
  ...
  HymnData(291, 'A! mba le l’ egberun ahon', [
    '''
...
'''
  ...
  HymnData(292, 'EYO, eyin mimo, e yin', [
    '''
...
'''
  ...
  HymnData(294, 'IRO t’ o dun ju orin', [
    '''
...
'''
  ...
  HymnData(295, 'IFE t’ o rekoja ero', [
    '''
...
'''
  ...
  HymnData(296, 'IFE mi s’ ibi ti wa pe', [
    '''
...
'''
  ...
  HymnData(297, 'KI sepe mo ko yan O', [
    '''
1. KI sepe mo ko yan O,
Oluwa, ko ri be,
Okan mi iba ko O,
Sugbon ‘Wo l’ o yan mi.
''',
    '''
2. Kuro ninu ese mi
O da mi ni ide,
O si yan mi s’ ona yi,
Ki mba le wa fun O.
''',
    '''
3. Anu t’ o pe l’ o yan mi,
L’ o si ko okan mi;
Aiye iba ti de mi,
Oju mi ‘ba ti fo.
''',
...
4. Emi fe O rekoja,
Mo nk’ ongbe anu Re,
Mo mo pe bi mba fe O.
Iwo l’ o ko fe mi.
'''
  ]),
  HymnData(298, 'ODODO Re nikan laise t’ emi', [
    '''
...
'''
  ...
  HymnData(300, 'AJIGBESE anu ni mi', [
    '''
...
'''
  ...
  HymnData(301, 'OKAN mi yin Oba orun', [
    '''
...
'''
  ...
  HymnData(302, 'YIN Olorun Abra’am', [
    '''
...
'''
  ...
  HymnData(303, 'FUN aanu t’ o po b’ iyanrin', [
    '''
...
'''
  ...
  HymnData(304, 'ITE anu! E je k’a lo', [
    '''
...
'''
  ...
  HymnData(305, 'NINU gbogbo iji ti nja', [
    '''
...
'''
  ...
  HymnData(306, 'IKOSE ti po to, t’ a nri', [
    '''
...
'''
  ...
  HymnData(307, 'LODO Re sibe nigbat’ ojumo mo', [
    '''
...
'''
  ...
  HymnData(308, 'JE, Oluwa, sin wa jeje', [
    '''
...
'''
  ...
  HymnData(309, 'NGO sunm’ O, Olorun', [
    '''
1. NGO sunm’ O, Olorun,
Ngo sunmo O;
B’ o tile se ‘ponju,
...
'''
  ...
  HymnData(310, 'OLORUN lat’ oro d’ ale', [
    '''
...
'''
  ...
  HymnData(311, 'WA k’ a da m’ awon ore wa', [
    '''
...
'''
  ...
  HymnData(312, 'GBA alare nwa sinmi', [
    '''
...
'''
  ...
  HymnData(313, 'ADUA didun adua didun', [
    '''
...
'''
  ...
  HymnData(315, 'TIRE l’ awa Kristi', [
    '''
1. TIRE l’ awa Kristi,
Titi aiyeraiye,
...
'''
  ...
  HymnData(316, 'B’ AYO aiye ti j’ asan to', [
    '''
...
'''
  ...
  HymnData(318, 'BUKUN ni fun ohun', [
    '''
1. BUKUN ni fun ohun,
...
'''
  ...
  HymnData(320, 'ARA e jek’ a jumo rin', [
    '''
...
'''
  ...
  HymnData(321, 'JESU, Iwo li a nwo', [
    '''
1. JESU, Iwo li a nwo,
K’ a repo l’ oruko Re;
Alade alafia,
...
'''
  ...
  HymnData(322, 'WO! b’ o ti dun to lati ri', [
    '''
...
'''
  ...
  HymnData(323, 'GBEKE re le Oluwa', [
    '''
1. GBEKE re le Oluwa,
...
'''
  ...
  HymnData(324, 'MO duro de Olorun mi', [
    '''
...
'''
  ...
  HymnData(325, 'ABA le n’ igbagbo aye', [
    '''
...
'''
  ...
  HymnData(326, 'IFE orun t’ o teriba', [
    '''
...
'''
  ...
  HymnData(327, 'ISIMI wa l’ orun, ko si l’ aiye yi', [
    '''
...
'''
  ...
  HymnData(328, 'IGBA wa mbe li owo Re', [
    '''
...
'''
  ...
  HymnData(332, 'OLUWA, ki s’agbara mi', [
    '''
...
'''
  ...
  HymnData(333, 'B’AIYE mi kun fun ‘banuje', [
    '''
...
'''
  ...
  HymnData(336, 'BABA mi, ‘gba mo nsako lo', [
    '''
...
'''
  ...
  HymnData(337, 'MO ti se ‘leri, Jesu', [
    '''
...
'''
  ...
  HymnData(338, 'JESU alail’ abawon', [
    '''
1. JESU alail’ abawon,
O ti f’ eje Re ra mi,
Nko nani ohunkohun,
...
'''
  ...
  HymnData(339, 'JI, okan mi, dide giri', [
    '''
...
'''
  ...
  HymnData(342, 'OG’ Oluwa j’ ohun ‘yanu', [
    '''
...
'''
  ...
  HymnData(345, 'ARA mi fun ‘rugbin rere', [
    '''
...
'''
  ...
  HymnData(350, 'JESU wipe k’ a ma sora', [
    '''
...
'''
  ...
  HymnData(351, 'OKAN wa ji; k’ eru fo lo', [
    '''
...
'''
  ...
  HymnData(352, 'OM’-OGUN Krist’ dide.', [
    '''
...
'''
  ...
  HymnData(353, 'EMA te siwaju, Kristian ologun', [
    '''
...
'''
  ...
  HymnData(355, 'KRISTIAN ma ti wa ‘simi,', [
    '''
...
'''
  ...
  HymnData(356, 'DURO, duro fun Jesu,', [
    '''
...
Joba titi lailai.'''
  ...
  HymnData(357, 'BABA orun, nin’ oro Re', [
    '''
...
'''
  ...
  HymnData(358, 'A, JEKI oro mimo Re', [
    '''
...
'''
  ...
  HymnData(359, 'BIBELI mimo t’ orun', [
    '''
...
'''
  ...
  HymnData(360, 'BABA orun, ti ife Re', [
    '''
...
'''
  ...
  HymnData(361, 'BAWO ni awon ewe wa', [
    '''
...
'''
  ...
  HymnData(362, 'BIBEL’ iwe aiyeraiye', [
    '''
...
'''
  ...
  HymnData(364, 'IWE kan wa ti kika re', [
    '''
1. IWE kan wa ti kika re,
Ko soro fun enia,
...
'''
  ...
  HymnData(365, 'TORI Mi at’ ihinrere', [
    '''
...
'''
  ...
  HymnData(367, 'JESU, Oba nla ni Sion', [
    '''
...
'''
  ...
  HymnData(368, 'JESU mo bg’ agbelebu mi', [
    '''
...
'''
  ...
  HymnData(369, 'ENI ‘rele, t’ o nwa ‘gbala', [
    '''
...
'''
  ...
  HymnData(372, 'L’ONA gbogbo t’ Oluwa yan', [
    '''
...
'''
  ...
  HymnData(373, 'JESU t’ O wa gba mi la', [
    '''
...
'''
  ...
  HymnData(375, 'OLUWA, nje ‘dariji Re', [
    '''
...
'''
  ...
  HymnData(376, 'OJO ayo l’ ojo ti mo', [
    '''
...
'''
  ...
  HymnData(377, 'A BAPTIS’ wa sinu iku', [
    '''
...
'''
  ...
  HymnData(378, 'JESU ni, “Gb’ agbelebu re', [
    '''
1. JESU ni, “Gb’ agbelebu re
Ki o si ma tele Mi,”
Oro yi ha le mu wa gbon?
...
'''
  ...
  HymnData(379, 'AKO ha gb’ oro wuwo ni', [
    '''
...
'''
  ...
  HymnData(381, 'BI a ti f’ okan wa fun O', [
    '''
...
'''
  ...
  HymnData(382, 'OLUWA orun at’ aiye', [
    '''
...
'''
  ...
  HymnData(383, 'WO t’ O teriba nin’ odo Jordani', [
    '''
...
'''
  ...
  HymnData(385, 'GBO ase ti Jesu pa', [
    '''
...
'''
  ...
  HymnData(386, 'GBO ohun t’ o dun lat’ oke', [
    '''
...
'''
  ...
  HymnData(387, 'ELESE, nipa ‘jewo re', [
    '''
...
'''
  ...
  HymnData(388, 'WO, awon t’ o wo ‘so ala', [
    '''
1. WO, awon t’ o wo ‘so ala,
Nwon duro leti odo,
...
'''
  ...
  HymnData(389, 'OHUN tin dun l’ aginju', [
    '''
...
'''
  ...
  HymnData(390, 'JESU Or’ elese mo de', [
    '''
...
'''
  ...
  HymnData(391, 'MO yo pipo pe Baba wa orun', [
    '''
1. MO yo pipo pe Baba wa orun
...
'''
  ...
  HymnData(394, 'IFE orun! alailegbe', [
    '''
1. IFE orun! alailegbe!
N’nu ase mimo yi,
...
'''
  ...
  HymnData(396, 'GBATI mo ri agbelebu,', [
    '''
...
'''
  ...
  HymnData(397, 'OKAN mi pe ninu Jesu', [
    '''
...
'''
  ...
  HymnData(399, 'ABBA, Baba,” a sunmo O', [
    '''
...
'''
  ...
  HymnData(400, 'NIWAJU ite anu Re', [
    '''
1. NIWAJU ite anu Re,
...
'''
  ...
  HymnData(401, 'JESU a de l’ ojo oni', [
    '''
...
'''
  ...
  HymnData(403, 'KIL’ o le w’ ese mi nu', [
    '''
...
'''
  ...
  HymnData(405, 'ALABUKUN n’ isun eje', [
    '''
...
'''
  ...
  HymnData(408, 'JEK’ alore Sion dide', [
    '''
...
'''
  ...
  HymnData(409, 'OLORUN ‘kore, te ‘ti Re', [
    '''
...
'''
  ...
  HymnData(410, 'IJINLE l’ oro Re, Jesu', [
    '''
...
'''
  ...
  HymnData(411, 'OWO l’ eni ororo Re', [
    '''
...
'''
  ...
  HymnData(412, 'KRIST’, nin’ ogba Eden', [
    '''
...
'''
  ...
  HymnData(413, 'NI Kanani ti Galili', [
    '''
...
'''
  ...
  HymnData(414, 'IRE t’ a su ni Eden', [
    '''
...
'''
  ...
  HymnData(415, 'JESU f’ ara han nitoto', [
    '''
...
'''
  ...
  HymnData(416, 'SIMI le Oluwa -e gbo', [
    '''
...
'''
  ...
  HymnData(417, 'JESU f’ eje Re raw a', [
    '''
...
'''
  ...
  HymnData(418, 'WA, Oluwa, l’ anu tun wa', [
    '''
...
'''
  ...
  HymnData(419, 'GBO l’ or’ ite Re, Alade', [
    '''
...
'''
  ...
  HymnData(420, 'OLUWA, mo gbo pe Iwo', [
    '''
...
'''
  ...
  HymnData(421, 'MA koja mi, Olugbala', [
    '''
...
'''
  ...
  HymnData(422, 'WO ‘le ‘wo enit’ a bukun', [
    '''
...
'''
  ...
  HymnData(423, 'ARA n’nu Krist’, nitori Re', [
    '''
...
'''
  ...
  HymnData(424, 'WO ‘le, ‘wo alabukunfun', [
    '''
...
'''
  ...
  HymnData(425, 'ENYIN enia Olorun', [
    '''
1. ENYIN enia Olorun,
Mo ti kiri aiye ka,
To ‘pa ese on ‘kanu,
...
'''
  ...
  HymnData(427, 'JI ‘se Re nde Jesu!', [
    '''
1. JI ‘se Re nde Jesu!
Fi agbara Re han!
...
'''
  ...
  HymnData(428, 'MA f’ ara fun ‘danwo, nitor' ese ni', [
    '''
...
'''
  ...
  HymnData(430, 'TO nwon, Baba si O', [
    '''
1. TO nwon, Baba si O,
To nwon si O;
Awon omo wonyi
...
'''
  ...
  HymnData(432, 'E DIDE ki a si lorin', [
    '''
...
'''
  ...
  HymnData(434, 'LEHIN ‘jo mefa t’ O sise', [
    '''
...
'''
  ...
  HymnData(435, 'JESU Oba, a pari eko wa', [
    '''
...
'''
  ...
  HymnData(436, 'K AWA to pari eko wa', [
    '''
...
'''
  ...
  HymnData(437, 'MO fe ki ndabi Jesu', [
    '''
...
'''
  ...
  HymnData(438, 'BI osun gbege eti ‘do', [
    '''
...
'''
  ...
  HymnData(439, 'ILE-EKO ojo ‘sinmi', [
    '''
1. ILE-EKO ojo ‘sinmi,
A, mo ti fe O to!
...
'''
  ...
  HymnData(440, 'OLORUN Baba, Krist’ Omo', [
    '''
...
'''
  ...
  HymnData(441, 'NIHIN, l’ oko Re Oluwa', [
    '''
...
'''
  ...
  HymnData(442, 'OLORUN Baba, Ologo', [
    '''
1. OLORUN Baba, Ologo,
...
'''
  ...
  HymnData(443, 'KRISTI n’ ipile wa', [
    '''
1. KRISTI n’ ipile wa,
Lori Re lao kole;
Awon mimo nikan,
...
'''
  ...
  HymnData(444, 'LAT’ oke tutu Grinland', [
    '''
...
'''
  ...
  HymnData(445, 'GBO ohun Jesu ti nke pe', [
    '''
...
'''
  ...
  HymnData(447, 'KEFERI nsegbe lojojo', [
    '''
...
''',
    '''
2. Oro, owo, e fi tore,
Na k’ e si na kin won le ye;
Ohun ti Jesu se fun nyin
Kil’ enyin iba se fun On?
'''
  ]),
  HymnData(448, 'WA, ma sise', [
    '''
1. WA, ma sise,
...
Ayo won, ‘simi won yio ti po to
Lod’ Oluwa.
'''
  ]),
  HymnData(449, 'WO b’ ikore ti po', [
    '''
1. WO b’ ikore ti po
L’ otun l’ osi wa,
Alagbase kere
...
'''
  ...
  HymnData(452, 'MA sise lo, mase sare', [
    '''
...
'''
  ...
  HymnData(453, 'JESU y’o joba ni gbogbo', [
    '''
...
'''
  ...
  HymnData(454, 'GBO! Orin ti Jubili', [
    '''
...
'''
  ...
  HymnData(455, 'FUNRUGBIN l’ owuro', [
    '''
1. FUNRUGBIN l’ owuro,
Ma simi tit’ ale;
...
'''
  ...
  HymnData(457, 'LO kede igbala Jesu', [
    '''
...
'''
  ...
  HymnData(459, 'FUN ‘rugbin l’ owuro, irugbin inu ‘re', [
    '''
1. FUN ‘rugbin l’ owuro, irugbin inu ‘re
...
''',
    '''
2. Funrugbin nin’ orun, ati nin’ojiji
...
''',
    '''
3. Bi a tile nf’ omije sise f’ Oluwa
...
'''
  ...
  HymnData(460, 'ATI gbo iro didun', [
    '''
1. ATI gbo iro didun,
Jesu le gba ni la,
Ji ‘se na yi aiye ka,
...
'''
  ...
  HymnData(461, 'KRISTI fun gbogb’ aiye', [
    '''
...
'''
  ...
  HymnData(463, 'OLUWA, ‘gbat’ a ngbadura', [
    '''
...
'''
  ...
  HymnData(464, 'OLUWA, jeki ore Re', [
    '''
1. OLUWA, jeki ore Re,
...
'''
  ...
  HymnData(468, 'OLUWA, Iwo l’ awa npe', [
    '''
...
'''
  ...
  HymnData(469, 'ORISUN lai, t’ ayo gbogbo', [
    '''
...
'''
  ...
  HymnData(470, 'YIN Olorun Oba wa', [
    '''
1. YIN Olorun Oba wa;
E gbe ohun iyin ga;
Anu Re o wa titi,
...
'''
  ...
  HymnData(472, 'A F’ ope f’ Olorun', [
    '''
1. A F’ ope f’ Olorun
L’ okan ati ohun wa,
Eni s’ ohun ‘yanu,
Ninu Enit’ araiye nyo;
Gbat’ a wa l’ omowo
On na l’ o ntoju wa,
O si nf’ ebun ife
Se ‘to ju wa sibe.
...
'''
  ...
  HymnData(473, 'AWA nbebe fun ‘le wa', [
    '''
...
'''
  ...
  HymnData(474, 'OLUWA wa, a nkorin ti', [
    '''
...
'''
  ...
  HymnData(475, 'WA, jek’ a tun pilese ajo wa', [
    '''
...
''',
    '''
4. A ti ta ‘fa na, igba si lo tan,
Odun Oluwa,
Si wa siwaju wa, aiyeraiye si de.
''',
    '''
5. Gbogbo wa ‘ba le wi l’ ojo wiwa Krist’ pe
“Emi ti lo ‘pa mi,
...
'''
  ...
  HymnData(476, 'AYIN O, Oluranwo wa', [
    '''
...
'''
  ...
  HymnData(477, 'OLUWA fi apa Re han', [
    '''
...
'''
  ...
  HymnData(478, 'OJO ati akoko nlo', [
    '''
1. OJO ati akoko nlo,
...
'''
  ...
  HymnData(479, 'BABA, je nya odun yi', [
    '''
...
'''
  ...
  HymnData(480, 'ODUN miran ti koja', [
    '''
...
'''
  ...
  HymnData(483, 'OLORUN t’ odun t’ o koja', [
    '''
...
'''
  ...
  HymnData(484, 'B’ ORUN l’ aiduro ti rin', [
    '''
...
'''
  ...
  HymnData(485, 'OLUWA at’ ‘igbala wa', [
    '''
...
Fun ni k’ a lo eyi ti nbo,
S’iyin Re ju odun t’ o lo.
'''
  ]),
  HymnData(486, 'NI akoko ipinya', [
    '''
1. NI akoko ipinya,
Jeki a fi ara wa,
S’ abe oju at’ okan,
...
'''
  ...
  HymnData(487, 'AO ha pade l’ eti odo', [
    '''
...
'''
  ...
  HymnData(488, 'K’ OLORUN so o, k’ a tun pade', [
    '''
1. K’ OLORUN so o, k’ a tun pade
Ki imoran Re gbe o ro,
K’ O ka o mo agutan Re,
...
''',
    '''
2. K’ Olorun so o, k’ a tun pade!
K’ O f’ iye Re dabobo o,
K’ O ma pese fun aini re,
K’ Olorun so o, k’ a tun pade!
  K’ a pade! etc.
''',
    '''
3. K’ Olorun so o, k’ a tun pade!
Nigbat’ ewu ba yi o ka,
K’ owo ife Re gba o mu,
K’ Olorun so o, k’ a tun pade!
  k’ a pade!etc.
''',
    '''
4. K’ Olorun so o, k’ a tun pade!
K’ O f’ ife Re rado bo o,
K’ O pa oro iku fun o,
K’ Olorun so o, k’ a tun pade!
  k’ a pade!etc.
'''
  ]),
  HymnData(489, 'NIHIN l’ awa nje ‘rora', [
    '''
...
L’ orun ko si ‘pinya,
  ...
  A! bi yio ti dun to!
  Gbat’ a ki yio pinya mo.
''',
    '''
2. Awon t’ o feran Jesu,
Nwon o lo s’ oke orun,
Lo b’ awon t’ o ti lo.
  A! bi yio ti dun to! etc.
''',
    '''
3. Omode yio wa nibe,
...
4. Oluko, baba, iya,
Nwon o pade nibe na,
Nwon ki yio pinya mo.
  A! bi yio ti dun to! etc.
''',
    '''
5. Bi a to ti yo po to!
...
'''
  ...
  HymnData(490, 'K’ ORE-ofe Krist’ Oluwa', [
    '''
...
'''
  ...
  HymnData(491, 'OLORUN l’ odo eniti', [
    '''
...
'''
  ...
  HymnData(492, 'JESU awa nwo O fun', [
    '''
...
'''
  ...
  HymnData(493, 'JESU ‘ wo Onisegun nla', [
    '''
...
'''
  ...
  HymnData(496, 'B’ ODO ti nyara san lo', [
    '''
1. B’ ODO ti nyara san lo,
Li ona gboro re,
Ti omi re nja titi,
T’ o nsare lo s’ okun,
Beni aiye wa nsan lo,
Ati ojo anu,
Enia si nsare lo si
‘Bit’ ipe anu pin.
''',
    '''
2. B’ awon osupa ti nwo,
Ti orun nsare lo,
B’ irahun iji ti mu
Ojo otutu de,
...
'''
  ...
  HymnData(497, 'KO mi ni iwon ojo mi', [
    '''
...
'''
  ...
  HymnData(498, 'OLORUN lat’ irandiran', [
    '''
...
''',
  ...
  HymnData(499, 'LAB’ ese, ati l’ oke wa', [
    '''
...
''',
  ...
  HymnData(500, 'ILE ‘simi, mo nreti re', [
    '''
...
''',
  ...
  HymnData(501, 'AKOKO ati lo mi ya', [
    '''
...
''',
  ...
  HymnData(502, 'ARA, b’ a ko tile gbo', [
    '''
...
''',
  ...
  HymnData(503, 'GB’ ohun t’ o t'orun wa ti wi', [
    '''
1. GB’ ohun t’ o t'orun wa ti wi
F’ awon mimo t’ o ku,
...
''',
  ...
  HymnData(504, 'KIKU n’nu Jesu, iku re', [
    '''
...
''',
  ...
  HymnData(505, 'IKU l’ opin ohun gbogbo', [
    '''
...
''',
  ...
  HymnData(506, 'O SUN,” ni Jesu wi', [
    '''
1. “O SUN,” ni Jesu wi
Nipa ti Lasaru,
Enit’ o ku, ti a ti san,
T’ a ti te s’ iboji.
''',
    '''
2. Oku ojo merin,
...
4. Sun, ara, olufe,
Jesu duro ti o,
Ma foya, O ti se ‘leri,
Ajinde f’ eni Re.
''',
    '''
5. O fere gb’ ohun na,
Lat’ oju orun re,
Ohun didun Jesu ti yio
Pe o si isoji.
''',
    '''
6. A ko ni b’ ara je
Bi alain’ ireti,
O d’ owuro l’ a le ki o,
Sun re, ara, sun re.
''',
    '''
7. Awa pelu yio sun
...
''',
  ...
  HymnData(507, 'GBAT’ a kun fun ‘banuje,', [
    '''
...
''',
  ...
  HymnData(508, 'ITANA t’ o bo ‘gbe l’ aso', [
    '''
...
''',
  ...
  HymnData(509, 'RANSE Olorun seun', [
    '''
1. RANSE Olorun seun;
Simi n’nu lala re;
...
Ojo ogun j ija pari,
Okan re r’ Alafia,
Omo-‘gun Krist’, o seun!
Ma korin ayo sa!
Simi lodo Olugbala,
Simi titi aiye.
''',
  ]),
  HymnData(510, 'MA sun lo, olufe; sa ma simi', [
    '''
...
''',
  ...
  HymnData(511, 'KI a to d’ awon oke nla', [
    '''
...
K’ a le l’ akoko wa rere,
Nigbose, k’ a le ba O gbe
Nib’ iye at’ ayo ki pin.
'''
  ]),
  HymnData(512, 'LALA alagbase tan', [
    '''
1. LALA alagbase tan;
Ojo ogun ti pari;
L’ ebute jinjin rere
...
''',
  ...
  HymnData(514,'GB’ ohun to t’ orun wa ti wi',[
        '''
...
''',
        '''
3. Onigbagbo to ku l’ aiye,
F’ ibanuje f’ awon ara,
Sugbon awon ogun orun
F’ ayo gbe lo s’ ese Jesu.
  Ma sokun mo, etc.
''',
        '''
...
''',
  ...
  HymnData(515,'NIGBAT’ ipe ba dun',[
        '''
1. NIGBAT’ ipe ba dun,
Ngo dide n’nu ‘boji,
Ngo r’ Onidajo Alade,
...
''',
  ...
  HymnData(516, 'NJ’ Onidajo yio wa',[
    '''
1. NJ’ Onidajo yio wa?
Nj’ oku yio ji dide?
...
''',
  ...
  HymnData(517,'GBA ‘Wo Onidajo ba de',[
    '''
...
‘Gba ‘bugbe Re l’ oke ba nho
Pel’ orin igbala.
''',
  ]),
  HymnData(518,'KO s’ aye ‘jafara nihin',[
    '''
...
''',
    '''
5. Yio si wi fun wa pe
Wa alabukunfun,
Gba ‘joba t’ a pese fun nyin
Lati aiyeraiye.
''',
  ]),
  HymnData(520, 'GBAT’ O ba de, gbat’ O ba de',[
    '''
...
''',
    '''
4. Sugbon f’ awon t’ o jewo Re,
T’ nwon fe, ti nwon sin l’ aiye,
...
''',
  ...
  HymnData(523, 'JERUSALEM ibi ayo',[
    '''
1. JERUSALEM ibi ayo,
T’ o se owon fun mi;
...
''',
  ...
  HymnData(526, 'ILE ewa wonni, b’ o ti dara to',[
    '''
...
''',
  ...
  HymnData(527, 'OKAN are, ile kan mbe',[
        '''
1. OKAN are, ile kan mbe,
Jina rere s’ aiye ise;
...
''',
  ...
  HymnData(529, 'JEKI m’ n’ ipo mi lodo Re',[
        '''
...
''',
  ...
  HymnData(530,'A! NWON ti gun s’ ebute',[
    '''
...
''',
  ...
  HymnData(531,'A! RO ti ibugbe orun',[
    '''
...
''',
  ...
  HymnData(533,'OJU ko ti ri, eti ko ti gbo',[
    '''
...
''',
  ...
  HymnData(534,'PARADISE! Paradise!',[
    '''
1. PARADISE! Paradise!
Tani ko fe simi?
...
''',
  ...
  HymnData(535,'ASORO ile ‘bukun ni',[
    '''
...
''',
  ...
  HymnData(536,'F’ AWON enia Re t’ o lo ‘simi',[
    '''
1. F’ AWON enia Re t’ o lo ‘simi
...
''',
  ...
  HymnData(537, 'OKE kan mbe jina rere',[
    '''
...
''',
  ...
  HymnData(539, 'LEHIN aiye buburu yi',[
    '''
...
''',
  ...
  HymnData(540, 'ALABUKUN n’nu Jesu',[
    '''
...
''',
  ...
  HymnData(541, 'AKO n’ ibugbe kan nihin',[
    '''
...
''',
  ...
  HymnData(542, 'AWON mimo! Ija nwon pin',[
    '''
...
Tabi riru igbi okun;
Awon mimo! eni ‘bukun
L’ebute abo ‘simi won.
''',
    '''
4. Awon mimo! nwon nso ona,
‘Gbat’ ara won sun n’ iboji,
Tit’ igbala ti nwon y’o jinde
Lati ti ayo goke lo;
...
''',
  ...
  HymnData(543, 'TAL’ awon wonyi b’ iranwo',[
    '''
...
''',
  ...
  HymnData(544 ,'EGBEGBERUN aimoye',[
    '''
1. EGBEGBERUN aimoye
Nwon wo aso ala,
...
''',
  ...
  HymnData(550, 'GB’ adura wa Oluwa',[
        '''
1. GB’ adura wa Oluwa,
...
''',
  ...
  HymnData(551, 'OLORUN Bethel, Eniti',[
        '''
...
''',
  ...
  HymnData(553, 'MA so fun mi l’ ohun aro',[
        '''
...
''',
  ...
  HymnData(554, 'YIKA or’ ite Olorun',[
        '''
...
''',
  ...
  HymnData(555, 'ORE kan mbe fun omode',[
        '''
...
''',
  ...
  HymnData(556,  'NIGBAKAN ni Betlehemu',[
        '''
...
'''
  ...
  HymnData(558, 'KINI gbogbo lala Re',[
        '''
...
'''
  ...
  HymnData(559, 'TAL’ o mo adun isimi', [
    '''
...
''',
    '''
6. A! k’ eyi je ‘pin mi, Jesu,
Se mi l’ ayanfe Re,
‘Gbana mo d’ alabukunfun
At’ elekun ayo.
   ''',
  ]),
  HymnData(560,	'JESU, nigba aiye Re',[
    '''
1. JESU, nigba aiye Re.
O ko dekun wo arùn;
Igbe irora aisan
Ko kàn O k' o bo le ri.
''',
    '''
2. Oju anu Re ko gbà
K'elese ma je 'rora,
B'o tile je pe 'ya na
To si i fun ese re.
''',
    '''
3. Nini ija ki emi
Le bo l'owo iparun
O ko gbagbe p'alafia
To s' eran ara pelu.
''',
    '''
4. B'alaisan ijo wa wo
Lor' akete irora
Onisegun Ododo,
Se awotan arun re.
''',
...
K' o le gbe ara le O,
K’ó mo pe Iwo nikan
L'O le pa, I' O le gbala.
''',
    '''
6. Ma je k'o siyeme ji
Ki irora mu bo ‘hun
Fun l' ebun lati wipe,,
"B' iye, b' iku, ife Re.
''',
    '''
7. K o le wu O lati wo
Alaisan ijo wa san
Bi beko awa mo pe
Fun rere ni ife Re.
'''
  ]),
  HymnData(561, 'ESE t' onigbagbo mberu?', [
    '''
1 ESE t' onigbagbo mberu?
Kini ba ma da won l' amu?
Iku Jesu le 'foya lo,
O mu isimi sokale.
''',
    '''
2 Kil' olori edun okan?
Kini gbogbo eda ntoro,
Lehin iye ainipekun
Ti Jesu ti f’awon Tire?
''',
    '''
3 Aimo daju onigbagbo
Li o mu iyemeji wa,
Jesu masai f' ara Re han,
K' O s'oro itunu fun wa
''',
    '''
4 O ko ko lati f' ara han
Om'-odo alaigbagbo ni,
Nigbat' o r'iho owo Re,
Lojukanna o jewo Re.
''',
    '''
5 A mo p' Olugbala ni O
T' a ran lati gba eda la
Sugbon fin wa n' itelorun,
Pe, O ti gba wa la pelu.
''',
    '''
6. Ao dagbere f' eru gbogbo,
Idamu wa yio si fo lo,
Nigbat' a ba mo daju pe,
Gbala Re ti te wa l'owo.
'''
  ]),
  HymnData(562, 'OM’ lorun, a ko ri O,', [
    '''
1. OM’ lorun, a ko ri O,
Gba O wa s' aiye iku yi
Awa ko ri ibugbe Re,
...
Sugbon, a gba oro Re gbó.
Jesu, Olurapada wa.
'''
  ]),
  HymnData(563, 'IGBAGBO l’ategun t’o so', [
    '''
1. IGBÀGBÒ I'ategun t'o so
Orun at' aiye po,
On l' Olugbala fi şisé
lyanu Re l'aiye.
''',
    '''
2. Igbagbo ni kękę Enok
Tió gùn lo s'orun:
On l'ó gba Ju meta ni là,
L’ o gba Daniel’ pelu
''',
    '''
...
''',
    '''
6. "K' o ri fun o b'igbagbo rę"
L'Olugbala wa wi
A! je ki ngba ohun nla gbo
Si O, Oluwa mi.
'''
  ]),
  HymnData(564, 'OLORI ijo t’orun,', [
    '''
1.OLORI ijo t'orun,
L'ayo l'a wólè fiun O
...
'''
  ...
  HymnData(565, 'TANI yio gbe Jakob’ dide?', [
    '''
1. T ANI yio gbe Jakob' dide?
Ore Jakob' ko po
Eyi t'o je 'yanu ni pe,
Imo won ko s' okan
''',
    '''
2. "Tani yio gbe Jakob' dide?
Ota Jakob' n' ipa:
Mo r' ayo 'segun I' oju won,
Nwon ni o pari fun.
''',
    '''
3. Tani yio gbe Jakob' dide?
A ha r' eni le wi?
Eka t'o ro nibule yi
O ha tun le ye mo?
''',
    '''
...
'''
  ...
  HymnData(567, 'NIHIN l’ Oluwa sin mi de,', [
    '''
1. NIHIN I' Oluwa sin mi de,
...
Mase jė k' eru ba nyin,
B' aini nyin, lagbara nyin.
''',
    '''
5. Nje, e má te siwaju,
E o ju asegun lo:
B' op' ota dojuko nyin,
Kristian, e te siwaju.
'''
  ]),
  HymnData(569, 'EREDI iwa s’ aiye mi?', [
    '''
1. EREDI iwá s' aiye mi?
Tori kil' a bi mi?
...
Enia l'o ga ju
Oga l'ero, l'oye, l'ogbon,
Li anfani gbogbo
''',
    '''
3. Idagba han l' otun, l' osi,
Ko s' ohun r' oduro,
A! okan mi ki ha şe fun
Idàgba l'a da o?
''',
    '''
4. Isise aiye mi poju,
Mo y' arara l'emi,
Op' odun kò je mi l' ere,
Mo si wa bakanna.
''',
    '''
...
'''
  ...
  HymnData(570, 'JEJE, lai si ariwo', [
    '''
1.JEJE, lai si ariwo,
Jeje li orun nran,
Gbat' o ba yo n' ila re,
Eda le w' oju re,
B o si t ngoke pele,
Je l' agbara re npo,
Titi y' o fi kan 'tari
N’ n’ ogo r' a ko le wo.
''',
    '''
2. Kokoro yun n 'nu okun,
Ko s' en' t' o gbó 'gbe re,
Kele l' o nsa ‘hun elo
Ti o fi nsise re,
Lai l' ago, lai p' okiki,
L' ó mu 'se re yori,
Ise re l' ewa tobe
T' enia nfi s' oso.
''',
...
Ko wa pelu iro;
Iji nla t' o si nwo 'le
Ti f’ategun jeje.
Bayi n' is' Emi Mimo
Li okan else,
Lai lu ‘lu, lai fen fere,
L' O so wa di mimo
''',
    '''
4. Jesu, jek' is' ore wa
Lo pelu ipamo,
K'a ma jeek' ow' otun wa
Mo ebo t' osi nru;
Laipe, nigbat' a ba şe
Ao ri b'ohun elo
Ti Angeli ti so di
Ade ogo fun wa.
'''
  ]),
  HymnData(571, 'OLUWA, iji nfe s’ oke!', [
    '''
1. OLUWA, iji nfe s' oke!
Igbi omi nru s' oke!
Oju orun pelu su dudu,
‘Ranlowo ko si n' tosi:
Wo ko bere bi a s segbe?
Ba, o n, Iwo se le sun?
Gbati 'seju kokan d' eru ba wa
Pe omi n' iboji wa,
  Afefe at, igbi yo se 'fe Mi;
  Dake je!
  Ibase ibinu riru okun,
  Ibase esu tab' ohunkohun,
  Ko si omi t' o le ri oko na,
  Ti Oluwa orun at' aiye wa,
  Nwon yio f’ inudidun șe ‘Fe
  Mi, Dake je! Dake je!
  Nwon yio f' inudidun se 'fe
  Mi, Dake je!
''',
    '''
2. Oluwa pel' edun èmi mi,
Mo teriba n' irònú,
Inu okan mi ko n' isimi:
A! ji k' O gbà mi, mo be!
igbi ese on ‘binuje,
Ti b' okan mi mole;
Mo segbé! Oluwa, mo sègbé!
...
'''
  ...
  HymnData(572, 'OJO Ibukun yio si ro!', [
    '''
1. OJO ibukun yio si ro!
Eyi n 'ileri ife;
A o ni itura didun
Lat' odo Olugbala,
  Ojo ibukun Ojo ibukun l' a nfe
  Iri anu wa yi wa ka, sugbon
  ojo l' antoro
''',
    '''
2. Ojo ibukun yio si ro!
Isoji iyebiye
Lori oke on petele.
Iro opo ojo mbo,
  Ojo ibukun! etc
...
'''
  ...
  HymnData(573, 'GBA Jesu ba de lati pin ere', [
    '''
1. GBA Jesu ba de lati pin èrè,
B' o j’ osan tabi l' oru,
Y'o ha ri wa nibit 'a gbe ns' ona,
Pel' atupa wa ti ntan
...
Ni yio pe wa l' okankan
Gbat' a f’ Oluwa l' ebun wa pada,
Yio ha dahun pe, "O seun?"
  A le wipe a mura tan, etc
''',
    '''
3. A s' oto ninu ilana Re,
Ti sa ipa wa gbogbo,
...
'''
  ...
  HymnData(574, 'LAB’ agbelebu Jesu', [
    '''
1. LAB' agbelebu Jesu
Mo fe lati duro,
Oji apata titobi
...
Gege bi a ti fi ala
Han Jakob' nigbani,
Be l' agbelebu ri fun mi,
Akaso si orun.
''',
    '''
3. Sugbon ni apa keji,
Labe ojiji re,
...
'''
  ...
  HymnData(576, 'L’ AYO l’ a ro t’ ore-ofe', [
    '''
1. LAYO l' a ro t' ore-ofe
Alufa wa l' oke
...
'''
  ...
  HymnData(578, 'ONISEGUN nla wa nihin,', [
    '''
...
'''
  ...
  HymnData(579, 'KO to k’ awon mimo beru,', [
    '''
1. KO to k' awon mimo beru,
Ki nwon so 'reti nu:
‘Gba nwon kò reti 'ranwo Re,
Olugbala yio de.
''',
    '''
...
'''
  ...
  HymnData(580, 'JESU fe mi, emi mo;', [
    '''
1. JESU fe mi, emi mo;
Bibeli so fun mi be
Tire l' awon omode,
...
'''
  ...
  HymnData(581, 'PELU mi nibiti mo nlo,', [
    '''
1. PELU mi nibiti mo nlo,
Kó mi l' ohun t' emi o se
Sá gbo aro at' oro mi,
...
Je ki emi gba Iwo gbo;
Ki nkorira nkan t' O ko fe,
K' emi si fe hun ti O fe
'''
  ]),
  HymnData(582, 'JESU l’ Olusagutan mi,', [
    '''
1. JESU l Olusagutan mi,
Ore Eniti ki ye!
Ko s' ewu bi mo je Tire.
T' On si je t' emi titi
''',
    '''
...
Gbogb ‘se wa y' o si tan.
'''
  ]),
  HymnData(584, 'OLORUN emi wa, at’ igbala wa,', [
    '''
1. OLORUN emi wa, at’ igbala wa,
‘Mole okinkun wa. 'reti ile wa,
Gbo, ki O si gba ebe ijo Re yi, Olodumare.
''',
    '''
...
Wo le gba ni là b' oku ese gbija;
...
'''
  ...
  HymnData(587, 'JESU t’ O wa l’ oke-orun,', [
    '''
...
''',
    '''
2. O nkiri, O si nse rere,
O nla ‘ju awon afoju;
Opo awon t' o si yaro,
O sanu won, O si so won.
''',
    '''
...
''',
    '''
6. Be l' O kú nitori 'yi na,
O d' enia k' O ba le kú
Bibeli ni, O t' orun wa,
K' O le dari ise ji ni.
''',
    '''
7. Olorun, O si f' ese ji
Awon t’ o ronupiwada;
Je k' a ji kuku w' oju Re.
K' a si gba ekun ore Re.
'''
  ]),
  HymnData(588, 'ENIKAN mbe t’ O feran wa,', [
    '''
...
'''
  ...
  HymnData(589, 'OLUWA wo wa l’ ese Re', [
    '''
1. OLUWA wo wa l' ese Re
Otosi else;
Gege bi eniti nbebe,
A wa ni ase Re.
''',
    '''
2. Awa mbebe f' awon 'mo wa,
T’ Iwo ti fi fun wa,
Tal' a o to n' igbà aini?
Bikose odo Re.
''',
    '''
...
4. Awa nfe Emi isoji.
K’ O tun okan won se,
Ki nwon le wa niwju Re,
Ki nwon le r’ ogo Re.
'''
  ]),
  HymnData(590, 'SI pepe Oluwa,', [
    '''
1. SI pepe Oluwa,
Mo mu 'banuje wa,
...
'''
  ...
  HymnData(591, 'MOKANDILOGORUN dubule je,', [
    '''
1. MOKANDILOGORUN dubule je,
Labe oji nin' agbo;
Sugbon okan je lo s' or' oke,
Jina s' ilekun wura;
Jina rere lor' oke sisa,
Jina rere s' Olus' agutan.
''',
    '''
2. "Mokandilogorun Tire l' eyi;
Jesu, nwon ko ha to fun O?”
Olus' agutan dahun, "T’ emi yi
Ti sako lo lodo Mi;
...
“Yo! Jesu m' ohun Tire pada!"
'''
  ]),
  HymnData(592, 'MO fe gbo itan kanna', [
    '''
1. M O fe gbo itan kanna
T' awon Angeli-nso
Bi Oba Ogo ti wá,
Gbe aiye osi yi;
Bi mo tile j' else,
...
Wá t' lwo t' Angeli Re,
Gbe orin ikore ga.
'''
  ]),
  HymnData(594, 'OHUN ogo Re l’ a nrohin', [
    '''
1. OHUN ogo Re 1' a nrohin,
Sion' ti Olorun wa;
Oro Enit' a ko le ye,
...
'''
  ...
  HymnData(595, 'OLUWA ni Oba;', [
    '''
1. OLUWA ni Oba;
E bo Oluwa nyin;
Eni kiku, s' ope,
Y' ayo 'segun titi;
Gb' okan at' ohun nyin s' oke,
  “E yo,” mo si tun wi "Eyo”
''',
    '''
2. Olugbala joba,
Olorun otito;
...
Lati mu 'ranse Re
Lo le aiyeraiye.
  A fe gb' ohun Angel' nla na
  Ipe y' o dun wipe, "E yo."
'''
  ]),
  HymnData(596, 'YO, eyin onigbagbo.', [
    '''
1.YO, enyin onigbabgo.
Je k' imole nyin tan:
Igba ale mbo tete,
Oru si fere de,
Oko iyawo dide,
...
'''
  ...
  HymnData(597, 'MO feran iwe oro Re;', [
    '''
1. MO feran iwe oro Re;
O f’ imole at’ ayo fun
Okan okun on ‘banuje!
Oro Re t' ona mi wiwo;
Eru Re ko jeki nsirin,
‘Leri Re m' okan ni simi.
''',
    '''
...
'''
  ...
  HymnData(599, 'WA ba mi gbe! ale fere le tan', [
    '''
...
Se 'imole mi, si toka si orun;
B' aiye ti nkoja, k' ile orun mo,
Ni yiye, ni kiku, wa ba mi gbe.
'''
  ]),
  HymnData(600, 'BABA orun! Emi fe wa', [
    '''
1. BABA orun! Emi fe wa
N’ iwa mimo, I' ododo;
Sugbon ife eran-ara
Ntan mi je nigbaghogbo
''',
    '''
2 Alailera l' emi se
Emi mi at' ara mi,
...
'''
  ...
  HymnData(601, 'OKAN mi odun kan ninu', [
    '''
1. OKAN mi, odun kan ninu
Aiye re koja lo;
Emi ko le gbe ihin pe,
Eyi le j' opin mi.
''',
    '''
2. Ji okan mi, f’ opo suru
Be iduro re wo;
Kini ohun to gbekele?
Kini ireti re?
''',
    '''
...
'''
  ...
  HymnData(602, 'LASAN ni ero mi nwa ‘pa,', [
    '''
...
''',
    '''
4. Oluwa fun mi l' ore-ofe
Ore Re le gb' okan mi ga,
De 'b' ayo pipe t' o l' ogo,
T' akoko ko le da duro.
'''
  ]),
  HymnData(603, 'JESU b’ oluso ma sin wa.', [
    '''
1. JESU b' oluso, ma sin wa,
A nfe, ike Re pupo;
F' onje didara Re bo wa,
Tún agbo Re se fun wa;
  Olugbala
  O ra wa, Tire l' a se.
''',
    '''
...
'''
  ...
  HymnData(604, 'BABA, a f’ ara wa,', [
    '''
1. BABA, a f’ ara wa,
S’ iso Re l' ale yi;
Da bobo wa, k' O pa wa mo,
Tit’ ile o fi mo.
'''
  ]),
  HymnData(605, 'BABA, Omo, on Emi,', [
    '''
1. BABA, Omo, on Emi,
Eni Metalokan lai,
Jo masai dabobo wa,
...
'''
  ...
  HymnData(606, 'ONTO mi lo iro ‘bukun,', [
    '''
...
'''
  ...
  HymnData(607, 'IGBALA ni, igbala ni,', [
    '''
...
'''
  ...
  HymnData(608, 'ITAN iyanu t’ ife! So fun mi lekan si,', [
    '''
...
'''
  ...
  HymnData(609, 'JESU nf’ ohun jeje pe o wa ‘le', [
    '''
1. JESU nf’ ohun jeje pe o wa 'le
O npe loni, o npé loni!
...
'''
  ...
  HymnData(610, 'A KO ni ‘bugbe kan nihin,', [
    '''
1.A KO ni 'bugbe kan nihin,
Onile e rora yanran;
B’ o fi gbogb' aiye ko Garet,
Ese mefa ni busun wa.
''',
    '''
2. A ko ni ‘bugbe kan nihin,
Or' aiye fowoba fi le
Ni horiho la sa w' aiye
Ni horiho lao pada lo.
''',
    '''
3. A ko ni 'bugbe kan nihin
O ko gbagbo p' ajo l' o wa?
Lo wo ‘boji w’ awon to sun,
Awan ni nwon de ‘bi simi.
'''
  ]),
  HymnData(611, 'OBIRIN t’ a mu ninu pansaga ‘se', [
    '''
1. OBIRIN t' a mu ninu pansaga 'se
On la mu wa fi sun niwaju Jesus;
Jesu terire ba, O nkowe n' ile:
T' agba t' ewe nf obinrin yi seleya.
We mi, emi o mo,
We mi, emi o mo;
Jo we mi emi o fun bi egbon owu.
''',
    '''
2. Nigbati Jesu gbe ori re soke
O wo gbogbo awon Olufisun ni;
O l' enikeni ti ko se 'ru yi ri,
Ko tete s' omobirin yi l'okuta.
''',
    '''
3. Jesu si tun te ori re ba sile,
T' agba t' ewe won si nyo lo lokokan
Gba Jesu si tun gbe ori soke,
Ko r' enikan a f' obirin yi nikan.
''',
    '''
4. Gbana ni Jesu wi f' obirin na pe;
Nibo l' awon Oluifisun re ni wa?
Gbogbo won ti lo lai da o lebi,
A dariji o ma si se 'ru re mo.
'''
  ]),
  HymnData(612, 'OLORUN mi! Olorun mi!', [
    '''
...
'''
  ...
  HymnData(614, 'ALEJO kan ma nkankun,', [
    '''
...
'''
  ...
  HymnData(615, 'ETUN won ko fun mi ki ngbo', [
    '''
...
''',
    '''
2. Kristi nikan lo nfi fun ni
Oro 'yanu t’ Iye!
Elese gbo ‘pe ife na
Oro yanu t' Iye
L' ofe la fifun wa, ko le to wa s' orun
  Oro didun! Oro 'yanu, etc
''',
    '''
...
'''
  ...
  HymnData(616, 'MO fi gbogbo re fun Jesu', [
    '''
...
'''
  ...
  HymnData(617, 'OLUWA mi, mo kepe O', [
    '''
...
''',
    '''
3. 'Gbagb awon ‘ya wa nfona han ni,
N'nu 'reti at' aigbagbo odo,
B' oju at' ona wa tile sookun,
T' ao ko tile le r' itoju Re.
‘Gbagbo Iya wa nto wa lo,
Ao di O mu titi d' opin.
''',
    '''
4. Gbagbo Iya wa, ti Kristi ni,
N’ otito to ta ‘jewo wa yo,
...
'''
  ...
  HymnData(620, 'BABA j’ owo gb’ adura wa,', [
    '''
1. BABA j' owo gb' adura wa,
...
'''
  ...
  HymnData(621, 'BABA wa Olodumare,', [
    '''
1. BABA wa Olodumare,
‘Wo t' o kawo igbi omi,
‘Wo t' o ti f’ ipo okun fun,
Ti ko le re ibe koja;
Gbo ti wa, gbat' a nke pe O,
F' awon t' o wa loju omi.
''',
    '''
...
'''
  ...
  HymnData(622, 'OLORUN so wa n ‘nu oko,', [
    '''
1. OLORUN so wa n' nu oko,
Larin omi jinjin,
S' oluso wa ba ti nwa lo,
Ninu ajin oru.
''',
    '''
2. Eru ko ye ki o ba wa,
Larin iji ti nja,
Niwon gba t' O wa nitosi
Larin omi ti nru.
''',
    '''
3. Iparoro ati iji,
T’ o nkoja lori' lė.
Iwo ni o da gbogbo won,
Nwon wa nikawo Re.
''',
    '''
4. Nigbat' awon Aposteli,
Wa lori ‘gbi okun,
Ase kan lat' odo Re wa,
Mu dake roro wa.
''',
    '''
5. Gbati iji to buru ju,
Ba nru l' atokan wa,
Oluwa ma sai ba wa gbe
F' alafia ba wa gbe.
''',
    '''
6. Ninu wahala aiye yi,
Ma se amona wa,
Titi ao fi de ‘le rere,
Nibi t' ese ko si.
'''
  ]),
  HymnData(623, 'APATA wa n’ ile are,', [
    '''
1. APATA wa n' ile are.
Ojji Re bo si iyanrin
O npe awo ero ti nkoja
...
F' aguntan t' o sonu lor' oke
Oluso agutan gun oke,
...
Bi t' ori omi Galili gbani,
  Sa wo Jesu nwi jeje pe, etc.
''',
    '''
3. Olugbala mo gbeke le o
Mo be O le eru mi lo
Mo mo po mu m' gunlė n' iye,
B' o ti wu ki ji na le to
Sa t' oju orun şu t' igbi ga,
Emi ki o pe O lasan,
Ma wi fun m’ pe,"emi ni."
Sa mu irumi dake je.
'''
  ]),
  HymnData(625, 'SION yara, k’ o je ise giga re,', [
    '''
...
''',
    '''
626.	JE ran orun kekere nibiti o nlo,
l JE ran orun kekere nibiti o nlo,
Se ranlowo lati le okunkun l' aiye,
‘Wo o ri b' okunkun yio ti lo kuro,
B' iwo ba je 'molė njojumo.
Je mole kekere b' o ti wu k' o mo,
Je mole t' o dara wo 'nu okunkun,
E o ri b' okunkun yio ti yara lo,
B' iwo ba je mole njojumo.
''',
    '''
2. Je ran orun kekere nibiti o nlo,
...
'''
  ...
  HymnData(628, 'NGO je ‘mole fun Jesu,', [
    '''
...
'''
  ...
  HymnData(630, 'A YIN O ‘lorun nitor’ Omo ‘fe re,', [
    '''
1. A YIN O ‘lorun nitor' Omo fe,
...
K' okan gbogbo gbina fun ina orun.
  Halleluya, tire logo, etc.
'''
  ]),
  HymnData(631, 'ORIN t’ o dun wa s’ okan mi,', [
    '''
1. ORIN t ‘o dun wa s' okan mi,
Orin ayo nu-didun,
...
'''
  ...
  HymnData(632, 'ARE mu o okan re poruru?', [
    '''
1. ARE mu o okan re poruru?
...
''',
    '''
4 Ironu iku mu o danu bi?
So o fun Jesu, so o fun Jesu,
Okan re nfe ijoba Jesu bi?
So o fun Jesu nikan
'''
  ]),
  HymnData(633, 'B' O ti dun lati gba Jesu', [
    '''
...
'''
  ...
  HymnData(634, 'T’ IFE Jesu t' o wa mi,', [
    '''
...
'''
  ...
  HymnData(635, 'NWON duro fun ete kan', [
    '''
...
'''
  ...
  HymnData(636, 'ENIKAN se ise wura', [
    '''
1. ENIKAN se ise wura;
On wa b' ore nigba aini
Enikan ko orin ayo
Nmu sanma da ni gbogb’ ojo
  Eni na ni o bi?
  Eni na ni o bi?
''',
    '''
...
'''
  ...
  HymnData(637, 'ORE ni Jesu fun mi, tito’ b Ife Re po', [
    '''
...
Mo jewo gbogb' asise mi,
Eru ese si bo.
  Beni Jesu ri, O nle okunkun lo.
  Beni Jesu ri, lojojo npa mi mo,
  Beni jesu ri, laginju yi ja,
  Gege bi ife nla Re.
''',
    '''
2. Nigbat' okunkun 'yonu su bo sanma l' oke
...
'''
  ...
  HymnData(638, 'GBATI ipe Oluwa ba dun', [
    '''
...
'''
  ...
  HymnData(639, 'IJA ti de, ipe si dun kikankikan', [
    '''
1. IJA ti de, ipe si dun kikankikan,
“Wo 'hamora!” nigbe jake-jado;
Oluwa omo-ogun nlo si isegun,
Ko pe ti segun krist' y' o farahan.
lja ti de, Kristian ologun,
L' ojukoju n' opo ija
B’ opagun ti nfe;
Ti hamora ndan, Are, ebi koju loni!
lja ti de, ma si se sare;
Se akoni n' agbara Re
B' Olorun l' aja, ab’ opagun Re.
Ao korin ‘segun nikehin!
''',
    '''
2. lja ti de, om' ogun oto e dide!
...
'''
  ...
  HymnData(640, 'MOLE k’ okan mi loni,', [
    '''
1. MOLE k’ okan mi loni,
...
'''
  ...
  HymnData(641, 'IWo ha nberu p' ota yio segun?', [
    '''
1. IWo ha nberu p\' ota yio segun?
Okun su lode o si su ju ninu?
...
'''
  ...
  HymnData(642, 'JESU fe k' emi je 'mole', [
    '''
1. JESU fe k' emi je 'mole
Ki ntan lojojumo;
Nibi gbogbo ki nle wu On,
N' ile ni skul, l' ode.
  Imole, mole,
...
'''
  ...
  HymnData(643, 'GBOGBO aiye ti nu', [
    '''
1. GBOGBO aiye ti nu s' okunkun ese,
Imole aiye ni Jesu!
...
''',
    '''
2 Ko 'sokunkun fun wa t' o wa 'nu Jesu,
Imole aiye ni Jesu.
...
'''
  ...
  HymnData(644, 'JESU nfe k' a f’ imole ti o pe tan.', [
    '''
...
N' ipò t' iwo wa at' emi pelu.
'''
  ]),
  HymnData(645, 'JESU ni gbogb' aiye fun mi,', [
    '''
...
'''
  ...
  HymnData(646, 'KO s' ore bi Jesu onirle,', [
    '''
1. KO s' ore bi Jesu onirle,
Ko s' okan! Ko s' okan!
...
''',
    '''
3, Ko s' akoko ti On ko sun mo wa,
Ko s' okan! Ko s' okan!
Ko s' oru ti ife Re ko tu won n’ nu
Ko s' okan! Ko s' okan!
''',
    '''
4. Enikan ha ti r' ore yi nko ni
Ko s' okan! Ko s' okan!
Tab’ elese ti ko ni gba on la?
Ko s' okan! Ko s' okan?
''',
    '''
...
'''
  ...
  HymnData(647, 'LASAN l\'adùn aiye npe mi;', [
    '''
1. LASAN l'adùn aiye npe mi;
Mo fe ki njọ Jesu,
Ohun aiye ko da mi ro;
Mo fe ki njo Jesu.
  Ki njo Jesu l' orin mi,
  Bi n' ile tabi l' ode
  Ki njo Jesu ngbagbogbo
  Mo fe ki njo Jesu.
''',
    '''
2. On ti da gbogbo ide mi,
Mo fe ki njo Jesu;
Ki nle sin on daradara,
Mo fe ki njo Jesu.
''',
    '''
3. Lati aiye de 'nu ogo,
Mo fe ki njo Jesu;
K' emi fon itan na kale,
Mo fe ki njo Jesu.
'''
  ]),
  HymnData(648, 'MO n 'Olugbala t' o mbebe' nin' ogo, [
    '''
1. MO n 'Olugbala t' o mbebe nin' ogo,
...
Si ma gbadura ki nwon le wo nu ogo
Adura re y' o gba o ti gba fun o!
'''
  ]),
  HymnData(649, 'MO n' ore, kan, A, Ore na!', [
    '''
1. MO n' ore, kan, A, Ore na!
N’ ife mi k' emi ti mo,
On f’ okun ife Re nla,
Fa mi sunmo odo Re
Ka okan mi ni 'fe nla na
...
Lati pa mi no l' ona mi,
Ki On si mu mi d' orun
Ogo ailopin le na han
Fun itunu Okan mi,
...
'''
  ...
  HymnData(650, 'OLUSAGUTAN ni npe mi', [
    '''
1. OLUSAGUTAN ni npe mi,
Kuro nin aginju ese,
...
'''
  ...
  HymnData(651, 'B’ IFE Olugbala ti dun to', [
    '''
...
'''
  ...
  HymnData(652, 'NGO ha ku ni owo ofo', [
    '''
...
'''
  ...
  HymnData(653, 'NGO korin itan 'yanu na', [
    '''
...
'''
  ...
  HymnData(654, 'MASE f’oiya ohun t’ o le de', [
    '''
...
'''
  ...
  HymnData(655, 'O TI to Jesu f’ agbara ‘wenumo', [
    '''
...
'''
  ...
  HymnData(656, 'WO kakiri f’ enit’ o s’ alaini', [
    '''
...
'''
  ...
  HymnData(657, 'NKO le sai gb’ ona agbelebu lo ‘le', [
    '''
...
'''
  ...
  HymnData(659, 'ENYIN ero, nibo l’e nlo', [
    '''
...
'''
  ...
  HymnData(660, 'OHUN ipe kan ti, oke petele wa', [
    '''
...
T’ olotito, ‘lotito, A! ‘lotito si Krist.
  Lo si isegun, lo si isegun, etc.
''',
    '''
3. Wa dapo m’ egbe wa, ao le Omiran na,
S’ olotito, ‘lotito, ‘lotito si Krist,
...
T’ olotito, ‘lotito, A! ‘lotito si Krist.
 ...
 ''', 
    '''
3. A fi agbara wa le Oluwa lowo
S’ olotito, ‘lotito, ‘lotito si Krist,
